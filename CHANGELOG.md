...
- x-forwarded-host overwrite for multi level proxies [`#1267`](https://github.com/http-party/node-http-proxy/pull/1267)
...
- Made it not to crash with omitted Host http header [`#1050`](https://github.com/http-party/node-http-proxy/pull/1050)
...
- [fix] more jshint indentation [`17399e7`](https://github.com/http-party/node-http-proxy/commit/17399e7c3ef9addf9dd8f7c628b273e693f128a1)
...
- Harmon message [`35ba0db`](https://github.com/http-party/node-http-proxy/commit/35ba0db554c6bace21b1bacfa8f5fb6df4228db0)
...
- Harmon message [`4e42354`](https://github.com/http-party/node-http-proxy/commit/4e42354e77d5731a383d516fc0b249d5d0eda745)
...
- If HTTP 1.1 is used and backend doesn't return 'Connection' header, explicitly  return Connection: keep-alive. [`#298`](https://github.com/http-party/node-http-proxy/pull/298)
...
- - support unix donain sockets and windows named pipes (socketPath) on node 0.8.x. On node 0.6.x the support was opaque via port, but on the new node, socketPath should be set explicitly. [`ffe74ed`](https://github.com/http-party/node-http-proxy/commit/ffe74ed299f81206b898147dbcc985519b2921f8)
...
- memory leak fix in closing of the sockets [`2055d0c`](https://github.com/http-party/node-http-proxy/commit/2055d0c8ec16699ffb06adf6d64d9506920b2071)
...
- cleaning [`8d87399`](https://github.com/http-party/node-http-proxy/commit/8d8739999fcaf4cdd8f2471046f6f036c44dc8f7)
- cleaning [`9672b99`](https://github.com/http-party/node-http-proxy/commit/9672b9927156a0dfe3ce4539f380aaf3172f6267)
...
- [fix] Dont use `-i` when running vows because it suppresses `--target=` and `--proxy=` CLI arguments [`1783ab0`](https://github.com/http-party/node-http-proxy/commit/1783ab0625743355eecc11f5cfd57469c429daa0)
...
- add "Using two certificates" to the https section of the readme.md [`#275`](https://github.com/http-party/node-http-proxy/pull/275)
...
- [api] Force connection header to be `close` until keep-alive is reimplemented [`3fd3c96`](https://github.com/http-party/node-http-proxy/commit/3fd3c96fa05fda45c7ef9ff44594644ac54f4a1e)
